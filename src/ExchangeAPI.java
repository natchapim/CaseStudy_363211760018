...
public class ExchangeAPI {
    ...
    private static String url_API =
            "https://v6.exchangerate-api.com/v6/d2831be136d819dd0584431f/latest/";
    ...
    public boolean getConnection(String base_code) {
        String json = "";
        URL url = null;
        HttpURLConnection requeat = null;

        try {
            url = new URL(url_API + base_code);
            requeat = (HttpURLConnection) url.openConnection();
    ...
    public double getEachBate(String newCurrency) {
        double eachRate = 0.0;
        try {
